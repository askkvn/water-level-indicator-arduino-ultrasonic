...
if ((distance  >= (int((totalHeight*95)/100)))){
...
else if((distance  >= (int((totalHeight*75)/100))) and (distance  <= (int((totalHeight*85)/100)))){
  Serial.println("20%");
  digitalWrite(empty, HIGH);
...
else if((distance  >= (int((totalHeight*55)/100))) and (distance  <= (int((totalHeight*65)/100)))){
  Serial.println("40%");
  digitalWrite(empty, HIGH);
  digitalWrite(low, HIGH);
...
else if((distance  >= (int((totalHeight*35)/100))) and (distance  <= (int((totalHeight*45)/100)))){
  Serial.println("60%");
  digitalWrite(empty, HIGH);
  digitalWrite(low, HIGH);
  digitalWrite(lowerMiddle, HIGH);
...
else if((distance  > (int((totalHeight*10)/100))) and (distance  <= (int((totalHeight*25)/100)))){
  Serial.println("80%");
  digitalWrite(empty, HIGH);
  digitalWrite(low, HIGH);
  digitalWrite(lowerMiddle, HIGH);
